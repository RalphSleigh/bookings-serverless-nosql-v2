...
export class VCampBookingConfirmationEmail extends EmailTemplate {
    ...
    HTMLBody(data: BookingEmailData, config: ConfigType) {
        ...
        return (<Html lang="en">
                ...
                <Text>
                    If for any reason you cannot add a reference, please send an email to <Link href={"mailto:info@venturercamp.org.uk"}>info@venturercamp.org.uk</Link> and let us know how much you paid, when you paid it and who it was for so we can match up payments.
                </Text>
                <Text>
                ...
                <Text>
                    <b>For any questions contact the Venturer Camp team on <Link href={"mailto:info@venturercamp.org.uk"}>info@venturercamp.org.uk</Link></b>
                </Text>
            </Html>)
    }
}